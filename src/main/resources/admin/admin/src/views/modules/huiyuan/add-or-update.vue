<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会员电话" prop="huiyuandianhua">
          <el-input v-model="ruleForm.huiyuandianhua" 
              placeholder="会员电话" clearable  :readonly="ro.huiyuandianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会员电话" prop="huiyuandianhua">
              <el-input v-model="ruleForm.huiyuandianhua" 
                placeholder="会员电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='huiyuandianhua'){
            this.ruleForm.huiyuandianhua = obj[o];
	    this.ro.huiyuandianhua = true;
            continue;
          }
          if(o=='touxiang'){
